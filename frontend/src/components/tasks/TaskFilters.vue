<template>
    <div class="mb-6 flex flex-wrap items-center gap-4">
      ...
      <div class="flex-1">
        <label for="filter" class="block mb-2 font-bold">Filter by Completion:</label>
        <select v-model="localIsCompletedFilter" class="p-2 border rounded w-full">
  ...
  const localIsCompletedFilter = ref<boolean | undefined>(props.isCompletedFilter);
